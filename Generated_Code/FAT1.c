...
)
{
  switch(drv) {
    case 0:
      return Carte_microSD_disk_initialize(drv);
    default:
      break;
  } /* switch */
  return RES_PARERR;
...
)
{
  switch(drv) {
    case 0:
      return Carte_microSD_disk_status(drv);
    default:
      break;
  } /* switch */
  return RES_PARERR;
...
)
{
  switch(drv) {
    case 0:
      return Carte_microSD_disk_read(drv, buff, sector, count);
    default:
      break;
  } /* switch */
  return RES_PARERR;
...
)
{
  switch(drv) {
    case 0:
      return Carte_microSD_disk_write(drv, buff, sector, count);
    default:
      break;
  } /* switch */
  return RES_PARERR;
...
)
{
  switch(drv) {
    case 0:
      return Carte_microSD_disk_ioctl(drv, ctrl, buff);
    default:
      break;
  } /* switch */
  return RES_PARERR;
...
bool FAT1_isWriteProtected(byte *drvStr)
{
  ...
  switch(drv) {
    case 0:
      return Carte_microSD_isWriteProtected();
    default:
      break;
  } /* switch */
  return TRUE;
...
bool FAT1_isDiskPresent(byte *drvStr)
{
  ...
  switch(drv) {
    case 0:
      return Carte_microSD_CardPresent();
    default:
      break;
  } /* switch */
  return FALSE;
...
byte FAT1_Deinit(void)
{
  ...
  if (Carte_microSD_Deinit(NULL)!=ERR_OK) {
    res = ERR_FAILED;
  }
  return res;
}
